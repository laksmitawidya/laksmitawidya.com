  ...
  return (
    <div className="p-5 mb-20 flex flex-col justify-center items-center">
      ...
      <div className="mt-20 max-w-3xl flex justify-center items-center text-center">
        My newbie project crafted with NextJS, written in Visual Studio, styled
        with TailwindCSS, NextUI and ShadCN UI, and sprinkled with design magic
        from Canva. Special thanks to ChatGPT for being my personal copy editor.
        Cheers to the team that made this possible! 😊
      </div>
    </div>
  );
};
